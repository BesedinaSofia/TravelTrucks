...
//   useEffect(() => {
//     if (Array.isArray(camper?.gallery) && camper.gallery.length > 0) {
//       const firstImage = camper.gallery[0]?.original;
//       if (typeof firstImage === 'string' && firstImage.trim() !== '') {
//         // Перевірка чи URL реально завантажується
//         const img = new Image();
//         img.src = firstImage;
//         img.onload = () => setImageUrl(firstImage);
...
function CamperCard({ camper }) {
  ...
  // Беремо тільки перше зображення з gallery
  const imageUrl =
